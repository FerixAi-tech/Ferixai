...
export default function LandingPricingPlans({
  ...
  return (
    <section className="pb-16 pt-4" id="pricing">
      <div className="lf-animate-in mb-10 flex justify-center px-4">
        <div className="w-full max-w-sm overflow-hidden rounded-[28px] border border-white/10 bg-[#0e0a18]/80 shadow-[0_24px_80px_rgba(0,0,0,0.45)]">
          <video
